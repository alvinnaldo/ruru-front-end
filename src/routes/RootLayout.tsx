...
export function RootLayout() {
  ...
  return (
    <div className="flex h-screen overflow-hidden transition-colors duration-200">
      ...
      <aside className="w-[260px] border-r border-[var(--color-border-light)] flex-shrink-0 flex flex-col bg-[var(--color-background-light)]">
        <div className="p-4 flex items-center h-16 border-b border-[var(--color-border-light)]">
      ...
      {/* Main Area */}
      <div className="flex-1 flex flex-col overflow-hidden bg-[var(--color-surface-light)]">
        {/* Top Navigation Bar */}
      ...
      <aside className="w-[320px] border-l border-[var(--color-border-light)] flex-shrink-0 flex flex-col bg-[var(--color-background-light)]">
        <div className="p-4 border-b border-[var(--color-border-light)] h-16 flex items-center">
        ...
        <div className="p-4 border-t border-[var(--color-border-light)] bg-[var(--color-surface-light)]">
          <div className="relative">
            <input
              type="text"
